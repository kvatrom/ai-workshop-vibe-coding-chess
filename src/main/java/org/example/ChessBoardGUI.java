...
/**
 * Simple Swing GUI for drawing the chessboard graphically. - Board drawn with blue/orange squares.
 * - Pieces drawn as Unicode glyphs in black color. - Origin square outlined in green, destination
 * in red. - The board panel is sized to roughly half the screen (square) and resizes nicely.
 */
