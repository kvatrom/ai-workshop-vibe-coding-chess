...
public class ChessBoardRenderer {
    ...
    public static String render(ChessBoard board, int fromFile, int fromRank, int toFile, int toRank) {
        ...
        for (int r = 7; r >= 0; r--) {
            ...
            for (int f = 0; f < 8; f++) {
                ...
                // Some very limited terminals may not support 256-color orange. If it renders as plain, user still sees blue/blank.
